...
class Layer(object):
    ...
    def RjTarget(self, SBInfo,SInfo,w):
        ...
        PTsjProb = self.getMotifjProb(SBInfo,SInfo, Ejs.T, mu,scale)
    ...
    def getMotifjProb(self,SBInfo,SInfo, Ejs, chemicalPotential,scale):
        # 所有序列存在motifj的概率
        uprobs = SInfo[0]
        bprobs=SBInfo[0]
